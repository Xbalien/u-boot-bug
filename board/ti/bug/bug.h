...
#define MUX_BUG() \
 ...
 /*GPMC*/\
	...
	MUX_VAL(CP(GPMC_NCS4),	(IEN | PTD | DIS  | M4)) /*GPMC_nCS4*/\
	MUX_VAL(CP(GPMC_NCS5),	(IEN | PTD | DIS  | M4)) /*GPMC_nCS5*/\
	MUX_VAL(CP(GPMC_NCS6),	(IEN | PTD | DIS  | M4)) /*GPMC_nCS6*/\
	MUX_VAL(CP(GPMC_NCS7),	(IEN | PTD | DIS  | M4)) /*GPMC_nCS7*/\
 ...
 /*Control and debug */\
	...
	MUX_VAL(CP(SYS_CLKOUT2), (IEN  | PTU | EN  | M4)) /*SYS_CLKOUT2*/\
